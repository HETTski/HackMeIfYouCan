...
urlpatterns = [
    ...
    path('api/all-users/', views.get_all_users, name='get_all_users'),  # Add this line
   ff path('api/fetch-and-decrypt-data/', views.fetch_and_decrypt_data, name='fetch_and_decrypt_data'),  # New endpoint
]